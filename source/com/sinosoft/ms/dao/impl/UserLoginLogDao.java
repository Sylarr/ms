 ...
 * @date 2014-11-05
 */
public class UserLoginLogDao extends BaseSupportDao {
	...
	public Bean read(Object... params) {
		return QueryHelper.read(UserLoginLog.class, "SELECT * FROM " + getBean().getTableName() + " WHERE LogId=?", params);
	}
	 ...
	 * @return
	 */
	private UserLoginLog cast(Bean bean) {
		if (bean == null || !(bean instanceof UserLoginLog)) {
			throw new BusinessException("UserLoginLog强转参数异常!");
		}
		return (UserLoginLog)bean;
	}
